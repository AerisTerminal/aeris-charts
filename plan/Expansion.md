...
- [ ] **CT6** Symbol comparison overlays with a shared comparison anchor and per-symbol legend
      values.
- [ ] **I1 moving averages:** HMA, VWMA, TEMA.
...
catalog remain open until the whole batch is implemented. DEMA, TEMA and SMMA/RMA are now exposed
...
| Indicators | SMA, EMA, DEMA, TEMA, SMMA/RMA, EMA ribbon, WMA, Bollinger, RSI, MACD, Stochastic, ATR, VWAP; incremental state; outputs are ordinary series, so indicator-on-indicator chaining already works | `engine/src/indicators.rs`, `indicators/src/lib.rs` |
...
Current: SMA, EMA, DEMA, TEMA, SMMA/RMA, EMA ribbon, WMA, Bollinger, RSI, MACD, Stochastic, ATR, VWAP. Each new indicator
