...
| Order book / depth | **Absent.** No Level 2 model, DOM, or liquidity heatmap | — |
...
liquidity heatmap, DOM, non-time bars, the I1–I3 indicator catalog and the full drawing catalog
with per-tool customization — using only typed engine APIs, with identical results across every
