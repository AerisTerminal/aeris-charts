...
//! targets later — web-sys `CanvasRenderingContext2d` in `origin_wasm` (browsers without WebGPU) and
//! a native rasterizer in `origin_native` (server PNGs + golden-image tests).
//!
