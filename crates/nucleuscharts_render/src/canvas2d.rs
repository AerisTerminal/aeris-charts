...
//! targets later — web-sys `CanvasRenderingContext2d` in `nucleuscharts_wasm` (browsers without WebGPU) and
//! a native rasterizer in `nucleuscharts_native` (server PNGs + golden-image tests).
//!
