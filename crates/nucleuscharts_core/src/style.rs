...
mod tests {
    ...
    fn canonical_dark_and_market_tokens_are_exact() {
        ...
        assert_eq!(DARK_MUTED_CSS, "#1b1b1b");
        assert_eq!(DARK_MUTED_FOREGROUND_CSS, "#a1a1a1");
        assert_eq!(DARK_BORDER_CSS, "#2c2c2c");
        assert_eq!(DARK_CROSSHAIR_CSS, DARK_BORDER_CSS);
        assert_eq!(DARK_SEPARATOR_HOVER_CSS, DARK_ACCENT_CSS);
        assert_eq!(MARKET_UP_CSS, "#07b57a");
        assert_eq!(MARKET_DOWN_CSS, "#ff4b62");
