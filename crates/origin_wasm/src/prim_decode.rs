...
use origin_engine::line_style_from_u8;
use origin_render::color::Color;
use origin_render::draw_list::{Gradient, IRect, LineType, Prim, TextAlign};
...
fn style(value: &serde_json::Value) -> origin_render::draw_list::LineStyle {
...
mod tests {
    use super::*;
    use origin_render::draw_list::LineStyle;
