//! origin_wasm — browser host shell.
//!
//! Phase 0: a real chart pipeline end to end — `origin_core` scales -> candle geometry ->
...
#[cfg(target_arch = "wasm32")]
pub use chart::{create_chart, OriginChart};
#[cfg(target_arch = "wasm32")]
pub use workspace::OriginWorkspace;
...
mod smoke {
    ...
    use origin_render::canvas2d::{execute, Viewport};
