...
//! list — wgpu here, the Canvas2D executor in `origin_render` (roadmap Phase D2). Previously the live
...
fn fill_polygon(poly: &[[f32; 2]], color: origin_render::color::Color, out: &mut Vec<TriVertex>) {
...
fn round_rect_to_tris(
    ...
    h: f32,
    radii: [f32; 4],
    fill: origin_render::color::Color,
    border_width: f32,
    border: origin_render::color::Color,
...
pub fn geom_prim_to_tris(prim: &Prim, points: &[[f32; 2]], out: &mut Vec<TriVertex>) {
    match prim {
        ...
        Prim::Background { rect, gradient } => {
            ...
            let to_f32 = |c: origin_render::color::Color| {
                [
                    c.r() as f32 / 255.0,
                    c.g() as f32 / 255.0,
                    c.b() as f32 / 255.0,
        ...
        Prim::BandFill {
            ...
            let v = |p: &origin_render::line::LinePoint| TriVertex {
...
mod tests {
    ...
    use origin_render::draw_list::Gradient;
    ...
    fn polyline_tessellates_to_stroke_only() {
        ...
        let prims = [Prim::Polyline {
            ...
            point_count: 3,
            width: 2.0,
            style: origin_render::draw_list::LineStyle::Solid,
