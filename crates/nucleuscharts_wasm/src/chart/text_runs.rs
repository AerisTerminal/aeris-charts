...
use nucleuscharts_render::draw_list::{text_font_spec, Prim};
use nucleuscharts_render_wgpu::{LabelAtlas, TexQuadInstance, ATLAS_SIZE};
    ...
    fn rasterize(
        ...
        if placement.w > ATLAS_SIZE || placement.h > ATLAS_SIZE {
            web_sys::console::warn_1(
                &format!(
                    "nucleuscharts: text run {:?} is {}x{} — larger than the label atlas; skipped",
