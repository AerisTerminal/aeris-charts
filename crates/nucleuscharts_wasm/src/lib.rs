//! nucleuscharts_wasm — browser host shell.
//!
//! Phase 0: a real chart pipeline end to end — `nucleuscharts_core` scales -> candle geometry ->
...
#[cfg(target_arch = "wasm32")]
pub use chart::{create_chart, NucleusChart};
#[cfg(target_arch = "wasm32")]
pub use workspace::NucleusWorkspace;
...
mod smoke {
    ...
    use nucleuscharts_render::canvas2d::{execute, Viewport};
