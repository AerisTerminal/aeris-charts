...
# they can be diffed against Nucleus's existing backends.
#
...
public static class WinCap
{
    ...
    public static string Capture(string title, string outPath)
    {
        ...
        if (!ClientToScreen(h, ref offset)) throw new Exception("ClientToScreen-failed");
        int offX = offset.X - wr.Left, offY = offset.Y - wr.Top;
