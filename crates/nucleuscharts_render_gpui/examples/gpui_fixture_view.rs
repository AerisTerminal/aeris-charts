...
//!
//! ```text
//! NUCLEUSCHARTS_FIXTURE=curved_brushes cargo run -p nucleuscharts_render_gpui \
...
use nucleuscharts_render_gpui::{fixtures, GpuiChartRenderer, NucleusViewport};
...
fn main() {
    let name = std::env::var("NUCLEUSCHARTS_FIXTURE").unwrap_or_else(|_| "curved_brushes".into());
