...
//! [`crate::backend`]) and by `nucleuscharts_native`'s tiny-skia rasterizer, and the two rasterizations
...
/// rounded rect. Both GPUI and WebGPU consume Nucleus's triangles; Canvas2D and tiny-skia describe
...
pub fn text(dpr: f32) -> Fixture {
    ...
    let labels: [(f32, f32, &str, TextAlign, u16); 5] = [
        ...
        (10.0, 140.0, "NUCLEUS", TextAlign::Left, 700),
