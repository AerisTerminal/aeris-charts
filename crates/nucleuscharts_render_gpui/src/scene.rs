...
//!
//! Coordinates are **device (bitmap) px**, matching the `Prim` IR (`nucleuscharts_render::draw_list`),
...
/// the one case where Nucleus's ramp is *wider* than the geometry (`build_area_fill` floors its
...
pub struct TextRun {
    ...
    pub family: String,
    pub align: nucleuscharts_render::draw_list::TextAlign,
