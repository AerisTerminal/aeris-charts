...
use origin_core::model::data_layer::{DataLayer, SeriesId};
use origin_core::model::data_validation::{
    sanitize_ohlc, sanitize_ohlc_styled, sanitize_point, ValidationError, ValidationReport,
};
use origin_core::model::magnet::CrosshairMode;
...
use origin_core::scale::time_scale_core::{TimeScaleCore, TimeScaleOptions};
use origin_core::scale::time_tick_marks::TimeTickMarks;
use origin_core::TimePointIndex;
use origin_render::color::Color;
use origin_render::draw_list::{LineStyle, LineType};
...
pub fn crosshair_mode_from_u8(mode: u8) -> CrosshairMode {
    use origin_core::options::crosshair_mode as wire;
    match mode {
...
pub struct ChartEngine {
    ...
    kinetic: Option<origin_core::model::kinetic_animation::KineticAnimation>,
...
impl ChartEngine {
    ...
    fn apply_chart_scale_options(&self, pane: &mut Pane) {
        ...
        let apply = |scale: &mut PriceScaleCore, group: &origin_core::options::PriceAxisOptions| {
