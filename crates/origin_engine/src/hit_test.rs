...
/// single-visible-point segment report `Point`, stroke segments report `Line`. Origin's
...
/// visible range — same set at the pane edges Origin draws). Shared with the brush drawing tool's
