//! Native rasterizer target for the [`origin_render::canvas2d`] executor (roadmap Phase D1/D2).
//!
...
mod tests {
    use super::*;
    use origin_engine::SeriesKind;
    use origin_render::draw_list::{Gradient, IRect};
