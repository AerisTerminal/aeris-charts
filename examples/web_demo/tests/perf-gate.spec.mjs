...
// Browser 60fps gate (roadmap O2 item O1): the native headless gates (crates/origin_native/
...
// frame times are not comparable to real GPUs. Set ORIGIN_PERF_STRICT=1 to enforce the
// budgets as hard assertions on machines with a real GPU.

const STRICT = process.env.ORIGIN_PERF_STRICT === "1";
